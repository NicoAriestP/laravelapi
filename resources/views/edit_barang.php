...
<p>{{namabarang}}<?php echo $_GET['id']; ?></p>
<p>{{harga}}</p>
<p>{{stok}}</p>
<button @click="EditBarang" class="btn btn-success ms-2 mb-2">Edit</button>
</div>
        <hr>
        ...
        mounted() {
            ...
            $.ajax({
                ...
                success:(res) => {
                    this.barangs = res.barang
                    console.log(res.barang)
                    this.namabarang = res.barang.nama_barang
                    this.harga = res.barang.harga
                    this.stok = res.barang.stok
                    // $('#namabarang').val(res.barang.nama_barang)
